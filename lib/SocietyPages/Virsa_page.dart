...
class VirsaPage extends StatelessWidget {
  const VirsaPage({Key? key}) : super(key: key);
              ...
              // theWidth is the width of the frostedglass
                ...
                theChild: Padding(
                  ...
                  child: Column(
                      ...
                      children:[
                        Image.asset('assets/pics/virsa.png',
                            width: 400,
                            height: 100,
                            fit:BoxFit.fill
                        ),
                        ...
                        Text('VIRSA-the essence of Punjab, TIET’s exclusive Punjabi cultural society,perpetuating and ennobling the rich heritage of Punjab all round. Virsa instils the opportunity to explore new boundaries,forte the adroitness and versatile spectrum for growth. ',
                        ...
                        Row(
                            ...
                            children: [
                              ...
                              TextButton(onPressed: ()async{
                                final Uri _url = Uri.parse('https://www.instagram.com/virsa.thapar/');
                        ...
                        Row(
                            ...
                            children: [
                              ...
                              TextButton(onPressed: ()async{
                                final Uri _url = Uri.parse('https://ssavirsa.com/');
