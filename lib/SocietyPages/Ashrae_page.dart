...
class AshraePage extends StatelessWidget {
  const AshraePage({Key? key}) : super(key: key);
                ...
                theChild: Padding(
                  ...
                  child: Column(
                      ...
                      children:[
                        ...
                        Text('From ventilation in the tallest buildings to cooling the fastest engines, We at the American Society for Heating Refrigeration and Air-conditioning Engineers, TIET Chapter strive to create HVAC innovative solution ',
                        ...
                        Row(
                            ...
                            children: [
                              ...
                              TextButton(onPressed: ()async{
                                final Uri _url = Uri.parse('https://instagram.com/ashrae_tiet?r=nametag');
