...
class TffPage extends StatelessWidget {
  const TffPage({Key? key}) : super(key: key);
...
//   const MyHomePage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('THAPAR FOOD FESTIVAL',
                ...
                theChild: Padding(
                  ...
                  child: Column(
                      ...
                      children:[
                        ...
                        Text(' Thapar Food Festival is one of the most magnificent and pompous fests at Thapar Institute of Engineering and Technology. he festival offers its diverse and humongous crowd a variety of appetizing and mouth-watering delicacies, marking its gigantic prosperity each time.The motive is to bring to light, the cuisines which are visually appealing and exquisitely flavored. ',
                        ...
                        Row(
                            ...
                            children: [
                              ...
                              TextButton(onPressed: ()async{
                                final Uri _url = Uri.parse('https://www.instagram.com/thaparfoodfestival/');
