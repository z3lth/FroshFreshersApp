...
class MlscPage extends StatelessWidget {
  const MlscPage({Key? key}) : super(key: key);
                      ...
                      children:[
                        ...
                        Row(
                            ...
                            children: [
                              ...
                              TextButton(onPressed: ()async{
                                final Uri _url = Uri.parse('https://instagram.com/mlsc_tiet');
                        ...
                        Row(
                            ...
                            children: [
                              ...
                              TextButton(onPressed: ()async{
                                final Uri _url = Uri.parse('https://mlsctiet.co.in/');
