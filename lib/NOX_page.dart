...
class NOXPage extends StatelessWidget {
  const NOXPage({Key? key}) : super(key: key);
              ...
              // theWidth is the width of the frostedglass
                ...
                theChild: Padding(
                  ...
                  child: Column(
                      ...
                      children:[
                        Image.asset('assets/pics/nox.png',
                            width: 400,
                            height: 150,
                            fit:BoxFit.fill
                        ),
                        ...
                        Text('Set in 2007, NOX is a creative western dance society of Thapar. We have come a long way from competing in Saturnalia to winning PECfest, BITS, Mood Indigo and Zietgiest (IIT Ropar) to name a few. Innumerable achievements and even more unforgettable memories have only made us keen to learn, grow and expand the horizon of new possibilities.',
                        ...
                        Row(
                            ...
                            children: [
                              ...
                              TextButton(onPressed: ()async{
                                final Uri _url = Uri.parse('https://instagram.com/nox_dance_society?igshid=YmMyMTA2M2Y=');
